...
#
# credits:
#    based on colorgrid by plasmarob:
...
colorhelp() {
    echo -e "\nTo write colored text, either begin with ${RED}\${ESC_SEQ}${COLOR_RESET} (${MAGENTA}\\\033[${COLOR_RESET}) and"
    echo -e "add a color code from ${MAGENTA}colorgrid()${COLOR_RESET}, "
    echo -e "or begin with ${RED}\${(RED|GREEN|YELLOW|BLUE|MAGENTA|CYAN)}${COLOR_RESET}."
    echo -e "Close the text with $RED\${COLOR_RESET}${COLOR_RESET} (${MAGENTA}\\\033[0m${COLOR_RESET})"
    echo -en "\nExample:\n${YELLOW}echo $RED-e $YELLOW\"$RED"
    echo -en "Look: ${MAGENTA}\${ESC_SEQ}${BLUE}38;5;243m${RED}This is dark grey text${MAGENTA}\${COLOR_RESET}${RED} and this is normal text."
    echo -e "$YELLOW\"$COLOR_RESET"

    echo -e "Look: ${ESC_SEQ}38;5;243mThis is dark gray text${COLOR_RESET} and this is normal text.\n"
}
