...
$BUILD_CONTEXT/$bin_dir/build.sh $REPO_NAME:codeserver $REMOTE_USER --build-arg HOMEBREW_ENABLED=true --build-arg PYTHON_VERSION=latest --build-arg DEFAULT_PASS_CHARSET='a-zA-Z0-9' $BUILD_CONTEXT
